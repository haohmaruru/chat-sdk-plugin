...
SWIFT_CLASS("_TtC10MessageKit23SwipeCollectionViewCell")
...
@interface MessageCollectionViewCell : SwipeCollectionViewCell
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10MessageKit11SwipeAction")
...
SWIFT_CLASS("_TtC10MessageKit16SwipeActionsView")
@interface SwipeActionsView : UIView
...
@interface SwipeCollectionViewCell (SWIFT_EXTENSION(MessageKit))
/// :nodoc:
